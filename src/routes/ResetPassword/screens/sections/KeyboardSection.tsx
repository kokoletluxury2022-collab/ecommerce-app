...
export const KeyboardSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[#d1d3d9] backdrop-blur-[54.37px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(54.37px)_brightness(100%)] py-2 px-[3px]">
      <div className="flex flex-col gap-3">
        ...
        <div className="relative h-[42px]">
          ...
          >
            <img
              ...
              alt="Shift active"
              src="https://c.animaapp.com/miuwhuqjs9jfDm/img/shift-active.svg"
            />
          </Button>

          <div className="absolute w-[275px] top-0 left-[58px] h-[42px]">
          ...
          >
            <img
              ...
              alt="Union"
              src="https://c.animaapp.com/miuwhuqjs9jfDm/img/union.svg"
            />
          </Button>
        </div>

        <div className="flex items-start gap-1.5 mt-[8px]">
          <Button
            variant="ghost"
        ...
        <div className="flex items-center justify-center mt-[9px]">
          <img
            className="w-[329px] h-7"
            alt="Emoji dictation"
            src="https://c.animaapp.com/miuwhuqjs9jfDm/img/emoji---dictation.svg"
          />
        </div>

        <div className="flex items-end justify-center mt-[3px] pb-2">
