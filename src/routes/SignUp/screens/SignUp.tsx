  ...
  return (
    <div className="bg-primary-0 w-full min-w-[390px] min-h-[844px] flex flex-col">
      ...
      <main className="flex-1 px-6 pt-3 pb-[27px] flex flex-col">
        ...
        <div className="flex flex-col gap-6 mt-[46px]">
          <div className="flex flex-col gap-1">
            ...
            <Input
              ...
              className="h-[52px] px-5 py-3.5 rounded-[10px] border-[#e6e6e6] font-b1-regular font-[number:var(--b1-regular-font-weight)] text-primary-400 text-[length:var(--b1-regular-font-size)] tracking-[var(--b1-regular-letter-spacing)] leading-[var(--b1-regular-line-height)] [font-style:var(--b1-regular-font-style)] placeholder:text-primary-400"
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <Input
                ...
                className="h-[52px] px-5 py-3.5 pr-14 rounded-[10px] border-[#e6e6e6] font-b1-regular font-[number:var(--b1-regular-font-weight)] text-primary-400 text-[length:var(--b1-regular-font-size)] tracking-[var(--b1-regular-letter-spacing)] leading-[var(--b1-regular-line-height)] [font-style:var(--b1-regular-font-style)] placeholder:text-primary-400"
              />
              <button
                type="button"
        ...
        <Button className="mt-16 h-[54px] bg-primary-200 hover:bg-primary-200/90 text-primary-0 rounded-[10px] font-b1-medium font-[number:var(--b1-medium-font-weight)] text-[length:var(--b1-medium-font-size)] tracking-[var(--b1-medium-letter-spacing)] leading-[var(--b1-medium-line-height)] [font-style:var(--b1-medium-font-style)]">
          Create an Account
        </Button>
