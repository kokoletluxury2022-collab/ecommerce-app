...
export const KeyboardSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[#d1d3d9] backdrop-blur-[54.37px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(54.37px)_brightness(100%)] pb-[34px]">
      <div className="w-full px-[3px] pt-2 flex flex-col gap-3">
        <div className="relative h-[42px]">
          {firstRowKeys.map((key, index) => (
            <Button
              key={`first-${index}`}
              variant="ghost"
              className={`absolute ${key.left} top-0 w-[38px] h-[42px] bg-primary-0 rounded-[4.6px] shadow-[0px_1px_0px_#0000004c] hover:bg-primary-100 p-0`}
            >
        ...
        <div className="relative h-[42px] mx-[19px]">
        ...
        <div className="relative h-[42px]">
          ...
          >
            <img
              ...
              alt="Shift active"
              src="https://c.animaapp.com/miuvyoq5GGbt0v/img/shift-active.svg"
            />
          </Button>

          <div className="absolute top-0 left-[58px] w-[275px] h-[42px]">
            {thirdRowKeys.map((key, index) => (
              <Button
                key={`third-${index}`}
                variant="ghost"
                className={`absolute ${key.left} top-0 w-[39px] h-[42px] bg-primary-0 rounded-[4.6px] shadow-[0px_1px_0px_#0000004c] hover:bg-primary-100 p-0`}
              >
                <span className="font-title2-regular font-[number:var(--title2-regular-font-weight)] text-primary-900 text-[length:var(--title2-regular-font-size)] tracking-[var(--title2-regular-letter-spacing)] leading-[var(--title2-regular-line-height)] [font-style:var(--title2-regular-font-style)]">
                  {key.letter}
                </span>
          ...
          <Button
            variant="ghost"
            className="absolute top-0 right-0 w-[42px] h-[42px] bg-[#abb0bc] rounded-[4.6px] shadow-[0px_1px_0px_#0000004c] hover:bg-[#9ba0ac] p-0 flex items-center justify-center"
          >
            <img
              className="-mt-px h-[17px] -ml-px w-[23px]"
              alt="Union"
              src="https://c.animaapp.com/miuvyoq5GGbt0v/img/union.svg"
            />
          </Button>
        </div>
      </div>
      ...
      <div className="flex w-full px-[3px] items-start gap-1.5 mt-3">
        <Button
          variant="ghost"
          className="w-[91px] h-[42px] bg-[#abb0bc] rounded-[4.6px] shadow-[0px_1px_0px_#0000004c] hover:bg-[#9ba0ac] p-0"
        >
      ...
      <div className="w-full px-[31px] mt-3">
        <img
          className="w-full h-7"
          alt="Emoji dictation"
          src="https://c.animaapp.com/miuvyoq5GGbt0v/img/emoji---dictation.svg"
        />
      </div>
